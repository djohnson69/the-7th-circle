  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-invert max-w-none text-muted-foreground">
        <p className="mb-6">
          The 7th Circle, LLC operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). The 7th Circle, LLC is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
        </p>
        ...
        <h2 className="text-2xl font-display font-bold uppercase tracking-wide text-foreground mt-12 mb-6">Personal Information We Collect or Process</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-display font-bold uppercase tracking-wide text-foreground mt-12 mb-6">Personal Information Sources</h2>
        ...
        <h2 className="text-2xl font-display font-bold uppercase tracking-wide text-foreground mt-12 mb-6">How We Use Your Personal Information</h2>
        <p className="mb-4">Depending on how you interact with us or which of the Services you use, we may use personal information for the following purposes:</p>
        <ul className="list-disc pl-6 space-y-2 mb-6">
        ...
        <h2 className="text-2xl font-display font-bold uppercase tracking-wide text-foreground mt-12 mb-6">How We Disclose Personal Information</h2>
        <p className="mb-4">In certain circumstances, we may disclose your personal information to third parties for legitimate purposes subject to this Privacy Policy. Such circumstances may include:</p>
        <ul className="list-disc pl-6 space-y-2 mb-6">
        ...
        <h2 className="text-2xl font-display font-bold uppercase tracking-wide text-foreground mt-12 mb-6">Relationship with Shopify</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-display font-bold uppercase tracking-wide text-foreground mt-12 mb-6">Third Party Websites and Links</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-display font-bold uppercase tracking-wide text-foreground mt-12 mb-6">Children's Data</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-display font-bold uppercase tracking-wide text-foreground mt-12 mb-6">Security and Retention of Your Information</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-display font-bold uppercase tracking-wide text-foreground mt-12 mb-6">Your Rights and Choices</h2>
        ...
        <p className="mb-6">
          We will not discriminate against you for exercising any of these rights. We may need to verify your identity before we can process your requests, as permitted or required under applicable law. In accordance with applicable laws, you may designate an authorized agent to make requests on your behalf to exercise your rights. Before accepting such a request from an agent, we will require that the agent provide proof you have authorized them to act on your behalf, and we may need you to verify your identity directly with us.
        </p>
        
        <h2 className="text-2xl font-display font-bold uppercase tracking-wide text-foreground mt-12 mb-6">Contact</h2>
        <p className="mb-6">
          If you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at support@the7thcircle.us.
        </p>
      </div>
    </div>
  );
